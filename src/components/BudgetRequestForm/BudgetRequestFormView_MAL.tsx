import { FormikValues, Formik, Form, Field, FieldProps } from "formik";
import {
  TextField,
  Alert,
  Button,
...
<Formik
        initialValues={{
          ticketsQuestion: ticketsQuestion[1],
          tickets: tickets[0],
          theatreZone: theatreZone[0],
          travelQuestion: travelQuestion[1],
          travel: travel[0],
          travelLevel: travelLevel[0],
          hotel: hotel[1],
          hotelStars: hotelStars[0],
